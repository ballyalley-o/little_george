const changeStockHTML = (product: any) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="container">
      <div>
        ...
        <div class="head_div" align="center">
          <h4>
            Hey, ${product.title} is now restocked! Grab yours before they run
            out again!
          </h4>
          ...
          <div align="center">
            <p>
              ...
              >
                <button type="button">See the the Product Here</button>
              </a>
            </p>
          </div>
          <div align="center">
...
export default changeStockHTML
