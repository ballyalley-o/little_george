const thresholdMetHTML = (product: any, threshold: any = 40) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="container">
      <div>
        ...
        <div class="head_div" align="center">
          <h3>
            Hey, ${product.title} is now available at a discount more than
            ${threshold}%!
          </h3>
          <div align="center">
            <p>
              ...
              >
                <button type="button">Grab it NOW!</button>
              </a>
            </p>
          </div>
          <div align="center">
...
export default thresholdMetHTML
